...
public class TambahBarang extends javax.swing.JFrame {
    ...
    public void judul(){
        Object[] judul = {"Kode Barang","Nama Barang","Merk","Harga Barang","Stok","Desc Barang"};
    ...
    private void initComponents() {
        ...
        btnLogout1.setBackground(new java.awt.Color(153, 153, 255));
        ...
        jLabel6.setText("Desc barang");

        JFileChooser.setText("Upload file");
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        ...
        if (kode.getText().equals("")) {
            ...
            stok.requestFocus();
        }else if(tempatfile.getText().equals("")) {
            JOptionPane.showMessageDialog(rootPane, "Desc Barang Wajib Diisi!");
            tempatfile.requestFocus();
        } else {
...
//                                    "harga='" + harga.getText() + "'," + "stok='" + stok.getText() + "'" + "file='" + tempatfile.getText() + "'");
                String sql = "INSERT INTO barang (id_barang, nama_barang, merk, harga, stok, file) VALUES (?, ?, ?, ?, ?, ?)";
                PreparedStatement pstmt = conn.prepareStatement(sql);
                pstmt.setString(1, kode.getText());
                pstmt.setString(2, namaBrg.getText());
                pstmt.setString(3, merk.getText());
                pstmt.setString(4, harga.getText());
                pstmt.setString(5, stok.getText());
                pstmt.setString(6, tempatfile.getText());
                pstmt.executeUpdate();
...
//                        "'," + "harga='" + harga.getText() + "'," + "stok='" + stok.getText() + "file='" + tempatfile.getText() + "' WHERE " 
...
//        }
        ...
        try {
            String sql = "UPDATE barang SET nama_barang=?, merk=?, harga=?, stok=?, file=? WHERE id_barang=?";
            PreparedStatement pstmt = conn.prepareStatement(sql);
            pstmt.setString(1, namaBrg.getText());
            pstmt.setString(2, merk.getText());
            pstmt.setString(3, harga.getText());
            pstmt.setString(4, stok.getText());
            pstmt.setString(5, tempatfile.getText());
            pstmt.setString(6, kode.getText());
            ...
            if (rowsAffected > 0) {
                ...
                JOptionPane.showMessageDialog(rootPane, "Tidak ada data yang diupdate. Periksa kembali kode barang.");
            }
        } catch (SQLException e) {
            e.printStackTrace();
            JOptionPane.showMessageDialog(rootPane, "Error saat update data: " + e.getMessage());
        }
    }
    ...
    private void tabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelMouseClicked
        ...
        tempatfile.setText(tabModel.getValueAt(tabel.getSelectedRow(), 5)+ "");
...
//                                    "%' or file like'%" + tempatfile.getText() + "%'");
//            
//            while(rs.next()){
//                Object[] data = {
//                    rs.getString("id_barang"),
...
//        }
    ...
    if (searchTerm.isEmpty()) {
        JOptionPane.showMessageDialog(rootPane, "Masukkan kata kunci pencarian!");
        return;
    }

    String sql = "SELECT * FROM barang WHERE id_barang LIKE ? OR nama_barang LIKE ? OR merk LIKE ? OR harga LIKE ? OR stok LIKE ?";
    ...
    try (PreparedStatement pstmt = conn.prepareStatement(sql)) {
        ...
        e.printStackTrace();
        JOptionPane.showMessageDialog(rootPane, "Error saat mencari data: " + e.getMessage());
    }
...
//    fileChooser.setFileFilter(new javax.swing.filechooser.FileNameExtensionFilter("Doc Files", "doc", "pdf"));
